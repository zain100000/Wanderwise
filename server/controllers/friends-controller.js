...
const acceptFriendRequest = async (req, res) => {
    try {
        ...
        user.pendingFriendRequests = user.pendingFriendRequests.filter(id => id.toString() !== friend.id.toString());
...
const getFriends = async (req, res) => {
    try {
        const user = await User.findById(req.user.id).populate('friends', 'name email profilePicture');
